<template>
  <div>
    ...
    <el-dialog title="添加分类" :visible.sync="addCateDialogVisible"
     width="50%"  @closed="addCateDialogClosed">
     <!-- 添加分类的表单 -->
    ...
    <!-- 编辑分类对话框 -->
    <el-dialog title="编辑" :visible.sync="editCateDialogVisible" width="50%"  @closed="editCateDialogClosed">
     <!-- 编辑分类的表单 -->
      <el-form :model="editCateForm" :rules="addCateFormRules" ref="editCateFormRef" label-width="100px">
        <el-form-item label="分类新名称" prop="cat_name">
